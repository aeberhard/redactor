...
/*abstract*/ class rex_form_redactor extends rex_form
{
  ...
  /*protected*/ function validate()
  {
    ...
    if (trim($el->getValue()) == '') {
      $msg .= $I18N->msg('redactor_profiles_noname')."<br />";
    }
    if ( preg_match('/[^0-9A-Za-z]/', $el->getValue()) ) {
      $msg .= $I18N->msg('redactor_profiles_nameinvalid')."<br />";
    }
