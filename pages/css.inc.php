...
if ($func == 'update')
{
  ...
  if ($sql->getRows() > 0)
  {
    ...
    {
      echo rex_warning($I18N->msg('redactor_css_not_saved'));
    }
  }
  else
  {
    ...
    $sqlu->setValue('description', 'CSS fuer den Redactor');
    $sqlu->setValue('configuration', $css);
    if($sqlu->insert())
    {
      echo rex_info($I18N->msg('redactor_css_saved'));
...
<div class="rex-form">
  <h2 class="rex-hl2"><?php echo $I18N->msg('redactor_css_title'); ?></h2>
  ...
  <div class="rex-form-wrapper">
    ...
    <div class="rex-form-row rex-form-element-v1">
      <p class="rex-form-text">
        <label for="css"><?php echo $I18N->msg('redactor_css_text'); ?></label>
...
<div class="rex-addon-output">
  ...
  <h2 class="rex-hl2"><?php echo $I18N->msg('redactor_css_infotitle'); ?></h2>

  <div class="rex-addon-content">
    <p class="rex-tx1">
    <?php echo $I18N->msg('redactor_css_info'); ?>
    </p>
  </div>
